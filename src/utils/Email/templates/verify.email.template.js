    ...
    <tr>
      <td>
        <table border="0" cellpadding="0" cellspacing="0" style="text-align:center;width:100%;background-color: #fff;">
          ...
          <tr>
            <td>
              <p style="padding:0px 100px;">Please use the OTP below to confirm your email.</p>
            </td>
          </tr>
          <tr>
            <td>
              <a href="#" style="margin:10px 0px 30px 0px;border-radius:4px;padding:10px 20px;border: 0;color:#fff;background-color:#630E2B; text-decoration:none;">Verify Email Address</a>
            </td>
          </tr>
        </table>
      </td>
    ...
    <tr>
      <td>
        <table border="0" width="100%" style="border-radius: 5px;text-align: center;">
          <tr>
            <td>
              <h2 style="margin-top:10px; color:#000;">${otp}</h2>
            </td>
          </tr>
          <tr>
            <td>
